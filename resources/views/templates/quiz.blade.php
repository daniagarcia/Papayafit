...
<body>
  <div class="headerquiz" style="height: 30rem; padding-top: 20rem;">
    <div style="padding-left:20rem;">
      <h3 style="color:#fff;">ANTES DE COMENZAR</h3>
      <strong class="" style="font-size: 4rem; color: #fff;">¿QUE TE GUSTARÍA LOGRAR?</strong>
    </div>
  </div>
  ...
  <form id="" action="/action_page.php">
    ...
    <div class="tab clearfix" style="margin-left: 2rem; line-height: 1rem; text-align: center; padding-left: 32rem; padding-top: 5rem;">
      <div onclick="nextPrev(1)" oninput="this.className = ''" class="divquiz"> 
        <strong class="textoquiz" style="color:#FF9D00; font-size: 1rem;  margin-top: 5rem;">
          <p style="margin-top: 2rem; font-size: 20px;">Bajar de peso disminuyendo % de grasa</p>
        </strong>
      </div><br>
      <div onclick="nextPrev(1)" oninput="this.className = ''" class="divquiz"> 
        <strong style="color:#FF9D00; font-size: 1rem;  margin-top: 5rem;">
          <p style="margin-top: 2rem; font-size: 20px;">Solo adquirir buenos hábitos alimenticios</p>
        </strong> 
      </div><br>
      <div onclick="nextPrev(1)" oninput="this.className = ''" class="divquiz">
         <strong style="color:#FF9D00; font-size: 1rem;  margin-top: 5rem;">
          <p style="margin-top: 2rem; font-size:  20px;">Aumentar mi peso de manera saludable</p>
        </strong>
      </div>

    </div>
    <!--CAMBIAR EL ESTILO DEL DIV SEXO-->
    <div class="tab clearfix" style="margin-left: 2rem; line-height: 1rem; text-align: center;padding-top: 5rem;">
      <div class="float-left" style="padding-left: 30rem;">
        <div onclick="nextPrev(1)" oninput="this.className = ''" class="divsexo"> 

          <img style="width: 60px; height:90px; padding-top:1rem;" src="/assets/Assets Papaya Fit/Group (1).png" alt="">
          <strong style="color:#FF9D00; font-size: 1rem;  margin-top: 5rem;">
            <p style="margin-top: 2rem; font-size: 1rem;">FEMENINO</p>
          </strong> </div><br><br>
      </div>
      <div class="float-right" style="padding-right:30rem;">
        <div onclick="nextPrev(1)" oninput="this.className = ''" class="divsexo">
          <img  style="width: 62px; height:86px;"src="/assets/Assets Papaya Fit/Vector (1).png" alt="">
          <strong
            style="color:#FF9D00; font-size: 1rem;  margin-top: 5rem;">
            <p style="margin-top: 2rem; font-size: 1rem;"></p>MASCULINO</strong> </div><br><br>
      </div>
    ...
    <div class="tab clearfix" style="margin-left: 15rem; line-height: 1rem; text-align: center;padding-top: 5rem;">
      ...
      <!-- <div class="tab" style="margin-left: 20rem; width: 390px; text-align: center; padding-left: 35rem;">
          <h1>ACTIVIDAD FÍSICA</h1> <br> <br>
            <button class="btncomienza">Casi nunca</button><br><br>
            <button class="btncomienza"></button> <br><br>
            <button class="btncomienza"></button> <br><br>
      </div> -->
      <div class="tab clearfix" style="margin-left: 2rem; line-height: 1rem; text-align: center; padding-left: 32rem; padding-top: 5rem;">
        <div onclick="nextPrev(1)" oninput="this.className = ''" class="divquiz"> 
      ...
      <!-- <div class="tab" style="margin-left: 20rem; width: 390px; text-align: center;">
      <h1>CON QUÉ OPCIÓN TE IDENTIFICAS</h1> <br> <br>

        <button class="btncomienza">Mi debilidad es lo dulce</button><br><br>
        <button class="btncomienza">Me gusta mucho la comida frita y grasosa</button> <br><br>
        <button class="btncomienza">Bebo refresco</button> <br><br>
        <button class="btncomienza">Consumo alcohol los fines de semana</button><br><br>
        <button class="btncomienza">Normalmente añado sal a los alimentos</button><br><br>}
        <button class="btncomienza">Ninguna de las anteriores</button><br><br>
