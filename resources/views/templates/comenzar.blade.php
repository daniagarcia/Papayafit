...
<body>
	...
	<div class="clearfix" style="margin-left: 8rem; margin-right: 5rem;">
		<h1 style="font-family:Open Sans; font-size: 5rem;">Tu plan de nutrición</h1>
		<h1 style="font-family:Open Sans; font-size: 5rem;">perzonalizado te espera</h1>
		<div class="float-left">
			...
			<div style="width: 40rem;">
				...
				<p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus facere minus id, sapiente libero
					debitis iste dolore ducimus rerum amet, quae facilis possimus voluptatibus voluptates, non commodi
					totam veniam laborum.</p>
			</div>
			<div class="row" style="padding-left:1rem;">
				<h2 style="color:#FF9D00;">Comenzar<br> </h2><img class="felcha" src="/assets/Assets Papaya Fit/Flecha.png"
					alt="">
			</div>
		</div>
