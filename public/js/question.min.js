$(document).ready(function () {
    ...
    //   console.info(formatNumber(111102665)) // 111,102,665
        if (OBJETIVO == "100" || OBJETIVO == "0" && GENERO == "f" && ACTIVIDAD == 1.2) {
            KCAL = 10 * PESO + 6.25 * ALTURA - 5 * EDAD - 161;
            REQ = KCAL * 1.2;
            console.log(REQ)
            // alert(formatNumber(REQ));
 


            // alert(REQ + " Requerimiento calorico")
        } else if (OBJETIVO == "100" || OBJETIVO == "0" && GENERO == "f" && ACTIVIDAD == 1.4) {
            KCAL = 10 * PESO + 6.25 * ALTURA - 5 * EDAD -161;
            REQ = KCAL * 1.4;
            console.log(REQ)
            // alert(REQ)
        } else if (OBJETIVO == "100" || OBJETIVO == "0" && GENERO == "f" && ACTIVIDAD == 1.6) {
            KCAL = 10 * PESO + 6.25 * ALTURA - 5 * EDAD  - 161;
            REQ = KCAL * 1.6;
            console.log(REQ)
            // alert(REQ + " Requerimiento calorico")
        } else if (OBJETIVO == "100" || OBJETIVO == "0" && GENERO == "m" && ACTIVIDAD == 1.3) {
            KCAL = 10 * PESO + 6.25 * ALTURA - 5 * EDAD + 5
            REQ = KCAL * 1.3;
            console.log(REQ)
            // alert(REQ + " Requerimiento calorico")
        } else if ( OBJETIVO == "100" || OBJETIVO == "0" && GENERO == "m" && ACTIVIDAD == 1.5) {
            KCAL = 10 * PESO + 6.25 * ALTURA - 5 * EDAD + 5
            REQ = KCAL * 1.5;
            console.log(REQ)
            // alert(REQ + " Requerimiento calorico")
        } else if ( OBJETIVO == "100" || OBJETIVO == "0" && GENERO == "m" && ACTIVIDAD == 1.7) {
            KCAL = 10 * PESO + 6.25 * ALTURA - 5 * EDAD + 5;
            REQ = KCAL * 1.7;
            console.log(REQ)
            // alert(REQ + " Requerimiento calorico")
